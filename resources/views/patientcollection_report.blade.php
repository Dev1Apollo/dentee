...
<table style="width: 100%;background-image: url(https://vgdcapp.vrajdentalclinic.com/assets/images/background.png);!important; padding: 60px;">
    ...
    <tbody>
    	...
    	<tr>
        	<td colspan="6" style="text-align: center; border: none;"><b>Branch:{{ $branchName }}</b></td>
    	</tr>
    	<tr>
        	<td colspan="6">&nbsp;</td>
    	</tr>
    ...
    <tbody style="width: 100%;border: 1px solid black;">
		...
		@foreach ($dailyCollection as $Dailycollection)
            <tr>
                ...
                <td style="border-top: 1px solid black;text-align: center;"> {{ $Dailycollection['patient_name'] }}</td>
                <td style="border-top: 1px solid black;text-align: center;">{{ $Dailycollection['payment_mode'] }}</td>
                <!-- <td style="border-top: 1px solid black;text-align: center;">{{ date('d-m-Y',strtotime($Dailycollection['order_date'])) }}</td> -->
                <td style="border-top: 1px solid black;text-align: center;">{{ $Dailycollection['amount'] }}</td>
                <td style="border-top: 1px solid black;text-align: center;">{{ $Dailycollection['receipt'] }}</td>
